...
for num in range(len(favorite_foods)):
  print("Alex's #" + str(num+1) + " favorite food is " + favorite_foods[num])
...
temp_name = many_names[0]
for name in many_names:
  if(len(name) >= len(temp_name)):
    temp_name = name
    
print("The longest name in the list is " + temp_name + ". It has " + str(len(temp_name)) + " letters in it." )
